...
//Это ворованый скрипт для пружинящих волос и т.д.
//Нормально работает только с тремя костями
//Странная вещь, просто эксперимент
public class SpringBone : MonoBehaviour
{
    public Vector3 springEnd = -Vector3.up;
