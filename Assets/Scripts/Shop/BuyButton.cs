...
namespace Shop
{
    ...
    public class BuyButton : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            _coin.sprite = Singletons._singletons.CurrencyManager[whatsBuySettings.buyingPerCurrency].Settings.icon;
        ...
        {
            _whatsBuy = Singletons._singletons.CurrencyManager[whatsBuySettings.currencyType];
        }
